            ...
            <Grid item xs={6} alignItems='center' className='imagem-cadastro2'>
                <Box paddingX={10}>
                    <form onSubmit={onSubmit}>
                        ...
                        <TextField value={user.usuario} onChange={(e:ChangeEvent<HTMLInputElement>) => updatedModel(e)} id='usuario' label='e-mail' variant='outlined' name='usuario' margin='normal'fullWidth className='textfield'/>
